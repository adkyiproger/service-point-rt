...
public class PageDecorator {
    ...
    public static Paper decorate(Paper paper) {
        ...
        int BORDER_TOP = Integer.parseInt(RepairTracker.PROPERTIES.getProperty("PRINTER_BORDER_TOP", "20"));
        int BORDER_LEFT = Integer.parseInt(RepairTracker.PROPERTIES.getProperty("PRINTER_BORDER_LEFT", "20"));
        int BORDER_RIGHT = Integer.parseInt(RepairTracker.PROPERTIES.getProperty("PRINTER_BORDER_RIGHT", "20"));
        int BORDER_BUTTOM = Integer.parseInt(RepairTracker.PROPERTIES.getProperty("PRINTER_BORDER_BUTTOM", "20"));
        String PRINTER_ORIENTATION=RepairTracker.PROPERTIES.getProperty("PRINTER_ORIENTATION","Portrait");
        ...
        LOGGER.info("Paper orientation: "+PRINTER_ORIENTATION);
